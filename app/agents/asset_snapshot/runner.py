...
from app.domain.schemas.asset_snapshot_evidence import AssetSnapshotRunResult
...
class AssetSnapshotGraphRunner:
    ...
    async def run(
        ...
        result = await self.run_result(request)
    ...
    async def run_result(
        ...
        if validated_output is None or evidence is None:
